...
#====================================================================
class ChargesTable(QtWidgets.QTableWidget):
...
#====================================================================
class NonBondTable(QtWidgets.QTableWidget):
    def __init__(self, hist, forceTab, parent=None):
...
#====================================================================
class BondsTable(QtWidgets.QTableWidget):
    def __init__(self, hist, forceTab, parent=None):
...
#====================================================================
class AnglesTable(QtWidgets.QTableWidget):
    def __init__(self, hist, forceTab, parent=None):
...
#====================================================================
class DihedralsTable(QtWidgets.QTableWidget):
    def __init__(self, hist, forceTab, parent=None):
...
class ForceTab(QtWidgets.QFrame):
...
class ForceSpinBox(QtWidgets.QDoubleSpinBox):
...
class ChargeSpinBox(QtWidgets.QDoubleSpinBox):
