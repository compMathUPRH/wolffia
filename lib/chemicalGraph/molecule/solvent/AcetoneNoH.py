...
class AcetoneNoH(Molecule):
	_FORCE_FIELD = None
	def __init__(self):
		Molecule.__init__(self, "AcetoneNoH")

		#print NANOCAD_PDB_DIR + "/Solvents/AcetoneNoH.pdb" , NANOCAD_PDB_DIR + "/Solvents/AcetoneNoH.psf" 
		self.load(NANOCAD_PDB_DIR + "/Solvents/AcetoneNoH.pdb" , NANOCAD_PDB_DIR + "/Solvents/AcetoneNoH.psf")


		if AcetoneNoH._FORCE_FIELD == None: 
			AcetoneNoH._FORCE_FIELD = ForceField(self, NANOCAD_FORCE_FIELDS + "/AcetoneNoH.prm")
		self.setForceField(AcetoneNoH._FORCE_FIELD )
